...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  const tabs = [
    ...
    },
    {
      key: "/wallet",
      title: t("tabs.wallet"),
      icon: activeKey === "/wallet" ? <Wallet theme="two-tone" size="24" fill={["#333", "#FFC300"]} /> : <Wallet size="24" />,
    },
    {
      key: "/bill",
      title: t("tabs.bill"),
      icon: activeKey === "/bill" ? <TransactionOrder theme="two-tone" size="24" fill={["#333", "#FFC300"]} /> : <TransactionOrder size="24" />,
    },
    {
      key: "/mine",
      title: t("tabs.mine"),
      icon: activeKey === "/mine" ? <User theme="two-tone" size="24" fill={["#333", "#FFC300"]} /> : <User size="24" />,
    },
  ]
